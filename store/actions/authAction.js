        ...
        async dispatch => {
            ...
            if (userEmail && userPassword) {
                const response = await fetch(
                    'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyC4FmYRkw4a5uIfoBqyAn3ZHPP322x8sB8',
                    {
                        method: 'POST',
                        headers: {
...
export const login = (userEmail, userPassword) => {
    ...
    return (
        async dispatch => {
            ...
            if (userEmail && userPassword) {
                const response = await fetch(
                    'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyC4FmYRkw4a5uIfoBqyAn3ZHPP322x8sB8',
                    {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
